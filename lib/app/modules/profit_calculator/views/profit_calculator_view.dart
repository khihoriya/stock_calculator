                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: const Center(
                            child: Text(
                              "Calculate",
                              style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,fontFamily: AppThemData.bold),
                            ),
                          ),
                        ),
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.green,fontFamily: AppThemData.bold),
                    ),
                  ],
                ),
              )),
                  ...
                  return Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text(
                          "PROFIT ",
                          style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green,fontFamily: AppThemData.bold),
                        ),
                        Text(
                  ...
                  return Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text(
                          "LOSS ",
                          style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red,fontFamily: AppThemData.bold),
                        ),
                        Text(
